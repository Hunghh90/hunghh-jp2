package practiceExamJava2.helper;
...
public class Connector {
        ...
        public final static String connectionString = "jdbc:mysql://localhost:3306/practiceexamjava2";
        public final static String user = "root";
        public final static String pwd = "";

        Connection conn;

        private static practiceExamJava2.helper.Connector instance;
        ...
        public static practiceExamJava2.helper.Connector getInstance() {
            if(instance == null){
                instance = new practiceExamJava2.helper.Connector();
            }
            return instance;
        }
